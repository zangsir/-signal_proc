...
xn = x + x1 + x2 + x3;
% Frequency analysis
% frequency: from 0 goes up to fs, sampling frequency, with the step . The number of
% frequency bins is the same as the number of bins in the time domain, noSamples=len(t). 
